...
exports.getGenreList = exports.getRecentlyAdded = exports.searchByGenre = exports.getEpisodeLinks = exports.search = exports.getAnimeDetails = exports.getPopular = exports.setBaseURL = void 0;
        ...
        yield axios_1.default
            ...
            try {
                ...
                $(".img").each((index, element) => {
                    ...
                    $(".released").map((idx, el) => {
                        if (idx === index)
                            released = parseInt($(el).text().replace("Released: ", "").trim());
                    });
